...
@JsonDeserialize(builder = ClassroomsRemoveEnrolledUserRequest.Builder.class)
public final class ClassroomsRemoveEnrolledUserRequest {
    private final Optional<Double> retMemberLimit;

    private final String userId;

    private ClassroomsRemoveEnrolledUserRequest(Optional<Double> retMemberLimit, String userId) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassroomsRemoveEnrolledUserRequest
                && equalTo((ClassroomsRemoveEnrolledUserRequest) other);
    }

    private boolean equalTo(ClassroomsRemoveEnrolledUserRequest other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClassroomsRemoveEnrolledUserRequest other);
    }

    public interface _FinalStage {
        ClassroomsRemoveEnrolledUserRequest build();
    ...
    public static final class Builder implements UserIdStage, _FinalStage {
        ...
        @Override
        public Builder from(ClassroomsRemoveEnrolledUserRequest other) {
        ...
        @Override
        public ClassroomsRemoveEnrolledUserRequest build() {
            return new ClassroomsRemoveEnrolledUserRequest(retMemberLimit, userId);
        }
    }
}
