package com.codecombat.api.client.stats.exceptions;
...
@JsonDeserialize(
    using = GetPlaytimeStatsException.Deserializer.class
)
public final class GetPlaytimeStatsException extends Exception {
  private final Value value;

  private int statusCode;

  private GetPlaytimeStatsException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetPlaytimeStatsException other(Object unknownValue, int statusCode) {
    return new GetPlaytimeStatsException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetPlaytimeStatsException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetPlaytimeStatsException> {
    @Override
    public GetPlaytimeStatsException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetPlaytimeStatsException(value, statusCode);
    }
  }
}
