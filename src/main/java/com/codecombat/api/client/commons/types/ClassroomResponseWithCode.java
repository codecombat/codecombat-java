...
@JsonDeserialize(
    builder = ClassroomResponseWithCode.Builder.class
)
public final class ClassroomResponseWithCode {
  ...
  private final Optional<List<Course>> courses;

  private final Optional<String> clanId;

  private int _cachedHashCode;

  ClassroomResponseWithCode(Optional<String> id, Optional<String> name,
      Optional<List<String>> members, Optional<String> ownerId, Optional<String> description,
      Optional<String> code, Optional<String> codeCamel, Optional<List<Course>> courses,
  ...
  private boolean equalTo(ClassroomResponseWithCode other) {
    return id.equals(other.id) && name.equals(other.name) && members.equals(other.members) && ownerId.equals(other.ownerId) && description.equals(other.description) && code.equals(other.code) && codeCamel.equals(other.codeCamel) && courses.equals(other.courses) && clanId.equals(other.clanId);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.id, this.name, this.members, this.ownerId, this.description, this.code, this.codeCamel, this.courses, this.clanId);
    }
  ...
  public String toString() {
    return "ClassroomResponseWithCode{" + "id: " + id + ", name: " + name + ", members: " + members + ", ownerId: " + ownerId + ", description: " + description + ", code: " + code + ", codeCamel: " + codeCamel + ", courses: " + courses + ", clanId: " + clanId + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<Course>> courses = Optional.empty();
    ...
    public Builder courses(Optional<List<Course>> courses) {
      this.courses = courses;
      return this;
    }
    ...
    public ClassroomResponseWithCode build() {
      return new ClassroomResponseWithCode(id, name, members, ownerId, description, code, codeCamel, courses, clanId);
    }
  }
}
