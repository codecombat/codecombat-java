...
@JsonDeserialize(
    builder = ClassroomResponse.Builder.class
)
public final class ClassroomResponse {
  ...
  ClassroomResponse(Optional<String> id, Optional<String> name, Optional<List<String>> members,
      Optional<String> ownerId, Optional<String> description, Optional<List<Course>> courses) {
    this.id = id;
    this.name = name;
  ...
  private boolean equalTo(ClassroomResponse other) {
    return id.equals(other.id) && name.equals(other.name) && members.equals(other.members) && ownerId.equals(other.ownerId) && description.equals(other.description) && courses.equals(other.courses);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.id, this.name, this.members, this.ownerId, this.description, this.courses);
    }
  ...
  public String toString() {
    return "ClassroomResponse{" + "id: " + id + ", name: " + name + ", members: " + members + ", ownerId: " + ownerId + ", description: " + description + ", courses: " + courses + "}";
  }
