...
public final class UpdateSubscription {
  ...
  public static final class Request {
    ...
    private final UpdateSubscriptionRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, UpdateSubscriptionRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public UpdateSubscriptionRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "UpdateSubscription.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(UpdateSubscriptionRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private UpdateSubscriptionRequest body;
      ...
      @Override
      public _FinalStage body(UpdateSubscriptionRequest body) {
        this.body = body;
        return this;
      }
