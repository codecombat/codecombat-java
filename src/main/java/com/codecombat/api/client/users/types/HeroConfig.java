...
@JsonDeserialize(
    builder = HeroConfig.Builder.class
)
public final class HeroConfig {
  ...
  HeroConfig(Optional<String> thangType) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof HeroConfig && equalTo((HeroConfig) other);
  }

  private boolean equalTo(HeroConfig other) {
  ...
  public String toString() {
    return "HeroConfig{" + "thangType: " + thangType + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(HeroConfig other) {
    ...
    public HeroConfig build() {
      return new HeroConfig(thangType);
    }
  }
}
