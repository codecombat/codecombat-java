...
public final class ShortenLicense {
  private ShortenLicense() {
  }

  public static final class Request {
    private final String handle;

    private final ShortenLicenseRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, ShortenLicenseRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public ShortenLicenseRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "ShortenLicense.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(ShortenLicenseRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private ShortenLicenseRequest body;
      ...
      @Override
      public _FinalStage body(ShortenLicenseRequest body) {
        this.body = body;
        return this;
      }
