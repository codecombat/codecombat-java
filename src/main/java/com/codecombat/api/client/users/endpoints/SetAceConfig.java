...
public final class SetAceConfig {
  private SetAceConfig() {
  }

  public static final class Request {
    private final String handle;

    private final com.codecombat.api.client.users.types.SetAceConfig body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, com.codecombat.api.client.users.types.SetAceConfig body,
    ...
    public com.codecombat.api.client.users.types.SetAceConfig getBody() {
      return body;
    }
    ...
    public String toString() {
      return "SetAceConfig.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(com.codecombat.api.client.users.types.SetAceConfig body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private com.codecombat.api.client.users.types.SetAceConfig body;
      ...
      @Override
      public _FinalStage body(com.codecombat.api.client.users.types.SetAceConfig body) {
        this.body = body;
        return this;
      }
