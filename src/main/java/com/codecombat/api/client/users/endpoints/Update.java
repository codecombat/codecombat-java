...
public final class Update {
  ...
  public static final class Request {
    ...
    private final UpdateUserRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, UpdateUserRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public UpdateUserRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "Update.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(UpdateUserRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private UpdateUserRequest body;
      ...
      @Override
      public _FinalStage body(UpdateUserRequest body) {
        this.body = body;
        return this;
      }
