...
public final class AddOAuthIdentity {
  private AddOAuthIdentity() {
  }

  public static final class Request {
    private final String handle;

    private final AddOAuthIdentityRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, AddOAuthIdentityRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public AddOAuthIdentityRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "AddOAuthIdentity.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(AddOAuthIdentityRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private AddOAuthIdentityRequest body;
      ...
      @Override
      public _FinalStage body(AddOAuthIdentityRequest body) {
        this.body = body;
        return this;
      }
