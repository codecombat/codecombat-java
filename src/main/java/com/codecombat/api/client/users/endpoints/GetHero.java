...
public final class GetHero {
  ...
  public static final class Request {
    ...
    private final GetHeroRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, GetHeroRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public String toString() {
      return "GetHero.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(GetHeroRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(GetHeroRequest body) {
        this.body = body;
        return this;
      }
