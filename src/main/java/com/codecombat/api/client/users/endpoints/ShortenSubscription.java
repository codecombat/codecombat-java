...
public final class ShortenSubscription {
  private ShortenSubscription() {
  }

  public static final class Request {
    private final String handle;

    private final ShortenSubscriptionRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, ShortenSubscriptionRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public ShortenSubscriptionRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "ShortenSubscription.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(ShortenSubscriptionRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private ShortenSubscriptionRequest body;
      ...
      @Override
      public _FinalStage body(ShortenSubscriptionRequest body) {
        this.body = body;
        return this;
      }
