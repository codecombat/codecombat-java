...
@JsonDeserialize(
    builder = DeleteUserFromClassroomRequest.Builder.class
)
public final class DeleteUserFromClassroomRequest {
  ...
  DeleteUserFromClassroomRequest(String userId, Optional<Double> retMemberLimit) {
    this.userId = userId;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeleteUserFromClassroomRequest && equalTo((DeleteUserFromClassroomRequest) other);
  }

  private boolean equalTo(DeleteUserFromClassroomRequest other) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.userId, this.retMemberLimit);
    }
  ...
  public String toString() {
    return "DeleteUserFromClassroomRequest{" + "userId: " + userId + ", retMemberLimit: " + retMemberLimit + "}";
  }
  ...
  public interface UserIdStage {
    ...
    Builder from(DeleteUserFromClassroomRequest other);
  }

  public interface _FinalStage {
    DeleteUserFromClassroomRequest build();
  ...
  public static final class Builder implements UserIdStage, _FinalStage {
    ...
    @Override
    public Builder from(DeleteUserFromClassroomRequest other) {
    ...
    @Override
    public DeleteUserFromClassroomRequest build() {
      return new DeleteUserFromClassroomRequest(userId, retMemberLimit);
    }
  }
}
