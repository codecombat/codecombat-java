...
public final class RemoveUserFromClassroom {
  private RemoveUserFromClassroom() {
  }
  ...
  public static final class Request {
    ...
    private final RemoveUserFromClassroomRequest body;
    ...
    Request(String classroomHandle, String courseHandle, Optional<Double> retMemberLimit,
        RemoveUserFromClassroomRequest body, Optional<BasicAuth> authOverride) {
    ...
    public RemoveUserFromClassroomRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "RemoveUserFromClassroom.Request{" + "classroomHandle: " + classroomHandle + ", courseHandle: " + courseHandle + ", retMemberLimit: " + retMemberLimit + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(RemoveUserFromClassroomRequest body);
    }
    ...
    public static final class Builder implements ClassroomHandleStage, CourseHandleStage, BodyStage, _FinalStage {
      ...
      private RemoveUserFromClassroomRequest body;
      ...
      @Override
      public _FinalStage body(RemoveUserFromClassroomRequest body) {
        this.body = body;
        return this;
      }
