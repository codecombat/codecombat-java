...
public final class UpsertFromClassroom {
  private UpsertFromClassroom() {
  }

  public static final class Request {
    private final String handle;

    private final UpsertClassroomRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, UpsertClassroomRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public UpsertClassroomRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "UpsertFromClassroom.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(UpsertClassroomRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private UpsertClassroomRequest body;
      ...
      @Override
      public _FinalStage body(UpsertClassroomRequest body) {
        this.body = body;
        return this;
      }
