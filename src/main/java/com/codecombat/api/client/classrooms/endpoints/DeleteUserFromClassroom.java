...
public final class DeleteUserFromClassroom {
  private DeleteUserFromClassroom() {
  }

  public static final class Request {
    private final String handle;

    private final DeleteUserFromClassroomRequest body;

    private final Optional<BasicAuth> authOverride;

    private int _cachedHashCode;

    Request(String handle, DeleteUserFromClassroomRequest body, Optional<BasicAuth> authOverride) {
      this.handle = handle;
      this.body = body;
    ...
    public DeleteUserFromClassroomRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "DeleteUserFromClassroom.Request{" + "handle: " + handle + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(DeleteUserFromClassroomRequest body);
    }
    ...
    public static final class Builder implements HandleStage, BodyStage, _FinalStage {
      ...
      private DeleteUserFromClassroomRequest body;
      ...
      @Override
      public _FinalStage body(DeleteUserFromClassroomRequest body) {
        this.body = body;
        return this;
      }
