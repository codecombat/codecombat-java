...
@JsonDeserialize(builder = UserResponseLicense.Builder.class)
public final class UserResponseLicense {
    private final Optional<String> ends;

    private final Optional<Boolean> active;

    private UserResponseLicense(Optional<String> ends, Optional<Boolean> active) {
        this.ends = ends;
        this.active = active;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UserResponseLicense && equalTo((UserResponseLicense) other);
    }

    private boolean equalTo(UserResponseLicense other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UserResponseLicense other) {
            ends(other.getEnds());
        ...
        public UserResponseLicense build() {
            return new UserResponseLicense(ends, active);
        }
    }
}
