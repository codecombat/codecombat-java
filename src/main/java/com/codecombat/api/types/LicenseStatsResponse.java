...
@JsonDeserialize(builder = LicenseStatsResponse.Builder.class)
public final class LicenseStatsResponse {
    ...
    private LicenseStatsResponse(
            Optional<Double> licenseDaysGranted,
            Optional<Double> licenseDaysUsed,
            Optional<Double> licenseDaysRemaining,
            Optional<Double> activeLicenses) {
    ...
    private boolean equalTo(LicenseStatsResponse other) {
        return licenseDaysGranted.equals(other.licenseDaysGranted)
                && licenseDaysUsed.equals(other.licenseDaysUsed)
                && licenseDaysRemaining.equals(other.licenseDaysRemaining)
                && activeLicenses.equals(other.activeLicenses);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                this.licenseDaysGranted, this.licenseDaysUsed, this.licenseDaysRemaining, this.activeLicenses);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "licenseDaysGranted", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "licenseDaysUsed", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "licenseDaysRemaining", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "activeLicenses", nulls = Nulls.SKIP)
