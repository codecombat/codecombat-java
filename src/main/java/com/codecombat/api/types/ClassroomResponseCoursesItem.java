...
@JsonDeserialize(builder = ClassroomResponseCoursesItem.Builder.class)
public final class ClassroomResponseCoursesItem {
    ...
    private ClassroomResponseCoursesItem(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClassroomResponseCoursesItem && equalTo((ClassroomResponseCoursesItem) other);
    }

    private boolean equalTo(ClassroomResponseCoursesItem other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClassroomResponseCoursesItem other) {
            id(other.getId());
        ...
        public ClassroomResponseCoursesItem build() {
            return new ClassroomResponseCoursesItem(id, levels, enrolled, instanceId);
        }
    }
}
